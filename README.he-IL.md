...
סימון _ה-O הגדול_ משמש לסיווג אלגוריתמים לפי כיצד זמן הריצה או דרישות המרחב שלהם גדלים ככל שגודל הקלט גדל.
...
כמה [פרויקטים](https://trekhleb.dev/projects/) ו[מאמרים](https://trekhleb.dev/blog/) נוספים על JavaScript ואלגוריתמים ב-[trekhleb.dev](https://trekhleb.dev)_ `B` [משחק הקפיצות](src/algorithms/uncategor _ `B` [חיפוש בינארי](src/algorithms
